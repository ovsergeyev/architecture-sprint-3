...
Микросервисы написаны на python FastAPI. Развертывание выполнено через docker-compose.

**Управление телеметрией** - добавлен в текущий репозиторий, папка telemetry
* Микросервис работает совместно с СУБД postgres

**Управление устройствами** - добавлен в текущий репозиторий, папка device-managment
